...
const Details = ({type,time,place,info})=>{
    ...
    <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between md:w-[80%]'>
        ...
        >
            <h3 className='capitalize font-bold text-2xl sm:text-xl xs:text-lg dark:text-orange-500'>{type}</h3>
...
const Education = () => {
  ...
  return (
    <div className='my-64'>
        <h2 className='font-bold text-8xl mb-32 w-full text-center md:text-6xl xs:text-4xl md:mb-16 dark:text-orange-500'>Why Choose Us ?</h2>
